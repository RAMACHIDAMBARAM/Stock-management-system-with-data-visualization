...
$query = mysql_query("UPDATE stock_management.users SET password='$password1' WHERE email_id='$email'");
$result = mysql_query("select username FROM stock_management.users WHERE email_id='$email'");
